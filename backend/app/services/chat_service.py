...
class ChatService:
    ...
    def _apply_response_length_guard(cls, response: str, response_style: str) -> str:
        limits = {"short": cls.MAX_SHORT_RESPONSE_CHARS, "medium": cls.MAX_MEDIUM_RESPONSE_CHARS, "long": cls.MAX_LONG_RESPONSE_CHARS}
        return (response or "").strip()[: limits.get(response_style, cls.MAX_MEDIUM_RESPONSE_CHARS)].rstrip()
